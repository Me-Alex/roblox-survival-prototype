...
SurvivalConfig.Regions = {
	{
		Id = "MarketCrossing",
		DisplayName = "Hearthmarket Crossing",
		Center = Vector3.new(0, 0, 16),
		Radius = 145,
		Color = Color3.fromRGB(64, 91, 67),
		Resources = { Tree = 1.15, Rock = 0.95, FiberPlant = 1.5, BerryBush = 1.4, MushroomCluster = 0.7, WaterSpring = 0.95, HerbPatch = 0.45 },
	},
	{
		Id = "FrostpineRise",
		DisplayName = "Frostpine Rise",
		Center = Vector3.new(-315, 0, -315),
		Radius = 185,
		Color = Color3.fromRGB(47, 84, 75),
		Resources = { Tree = 2.45, FiberPlant = 1.15, BerryBush = 1.05, HerbPatch = 0.85, MushroomCluster = 0.9, Rock = 0.55, LootCache = 0.35 },
	},
	{
		Id = "GlasswaterFen",
		DisplayName = "Glasswater Fen",
		Center = Vector3.new(330, 0, -300),
		Radius = 180,
		Color = Color3.fromRGB(48, 100, 96),
		Resources = { WaterSpring = 2.3, FiberPlant = 1.8, HerbPatch = 1.55, MushroomCluster = 1.65, BerryBush = 1.0, Tree = 0.7, LootCache = 0.35 },
	},
	{
		Id = "RustjawQuarry",
		DisplayName = "Rustjaw Quarry",
		Center = Vector3.new(-360, 0, 305),
		Radius = 185,
		Color = Color3.fromRGB(111, 94, 79),
		Resources = { Rock = 2.45, IronDeposit = 1.75, LootCache = 0.8, HouseLoot = 0.5, HerbPatch = 0.45, Tree = 0.35, FiberPlant = 0.45 },
	},
	{
		Id = "WreckersCove",
		DisplayName = "Wreckers' Cove",
		Center = Vector3.new(360, 0, 325),
		Radius = 180,
		Color = Color3.fromRGB(76, 100, 112),
		Resources = { LootCache = 1.3, HouseLoot = 1.65, WaterSpring = 1.15, BerryBush = 1.05, MushroomCluster = 0.75, Rock = 0.9, Tree = 0.65, FiberPlant = 0.65 },
	},
	{
		Id = "MoonwillowGrove",
		DisplayName = "Moonwillow Grove",
		Center = Vector3.new(-585, 0, -35),
		Radius = 170,
		Color = Color3.fromRGB(61, 95, 83),
		Resources = { Tree = 2.2, FiberPlant = 1.7, BerryBush = 1.45, HerbPatch = 1.35, MushroomCluster = 1.25, Rock = 0.45, WaterSpring = 0.75 },
	},
	{
		Id = "AshfallFoundry",
		DisplayName = "Ashfall Foundry",
		Center = Vector3.new(585, 0, 35),
		Radius = 175,
		Color = Color3.fromRGB(115, 80, 66),
		Resources = { IronDeposit = 2.25, Rock = 1.8, LootCache = 1.05, HouseLoot = 0.75, HerbPatch = 0.45, Tree = 0.25, WaterSpring = 0.45 },
	},
	{
		Id = "StarfallObservatory",
		DisplayName = "Starfall Observatory",
		Center = Vector3.new(10, 0, -565),
		Radius = 170,
		Color = Color3.fromRGB(90, 86, 116),
		Resources = { LootCache = 1.55, HouseLoot = 0.95, Rock = 1.35, IronDeposit = 0.85, HerbPatch = 0.8, MushroomCluster = 0.75, Tree = 0.55 },
	},
}
